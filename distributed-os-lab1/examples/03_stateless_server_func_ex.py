...
def apply_func(infile, outfiles):
    with open(infile) as fp_in, ExitStack() as stack:
        ...
        for index, line in enumerate(fp_in):
            ...
            result = line.rstrip() + "_adding_some_work\n"
...
def main():
    ...
    # https://stackoverflow.com/questions/52993976/grpc-python-support-multithreading-on-client-and-server
    ...
    #               one output channel.
    apply_func(args.infile, args.outfile)
